...
public class MyViewPager extends RelativeLayout implements ViewPager.OnPageChangeListener {
    ...
    private final static class TimeTaskHandler extends Handler {
        private WeakReference<MyViewPager> mRollPagerViewWeakReference;

        public TimeTaskHandler(MyViewPager rollPagerView) {
            this.mRollPagerViewWeakReference = new WeakReference<>(rollPagerView);
        }

        @Override
        public void handleMessage(Message msg) {
            MyViewPager rollPagerView = mRollPagerViewWeakReference.get();
    ...
    private static class WeakTimerTask extends TimerTask {
        ...
        public WeakTimerTask(MyViewPager mRollPagerView) {
