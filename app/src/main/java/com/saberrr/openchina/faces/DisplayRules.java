...
public enum DisplayRules {
    ...
    private DisplayRules(int type, int value, int resId, String cls, String remote) {
        this.type = type;
        this.emojiStr = cls;
        this.value = value;
        this.resId = resId;
    ...
    private static FaceBean getEmojiFromEnum(DisplayRules data) {
        return new FaceBean(data.getResId(), data.getValue(), data.getEmojiStr(), data.getRemote());
    }

    public static FaceBean getEmojiFromRes(int resId) {
    ...
    public static FaceBean getEmojiFromValue(int value) {
        for (DisplayRules data : values()) {
    ...
    public static FaceBean getEmojiFromName(String emojiStr) {
        for (DisplayRules data : values()) {
    ...
    public static List<FaceBean> getAllByType(int type) {
        List<FaceBean> datas = new ArrayList<>(values().length);
        for (DisplayRules data : values()) {
